...
//
// TX PDO (drive → master), 55 bytes, Python format "<HbifhfHiiiffffff":
...
// Pack a Command into raw RX PDO bytes using the current DS402 state.
...
// Unpack raw TX PDO bytes into a DriveStatus.
